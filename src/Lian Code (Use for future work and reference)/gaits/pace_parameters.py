...
SPEED_STANCE = [1.3 for i in range(OSCILLATOR_NUMBERS)]
SPEED_SWING = [1.3 for i in range(OSCILLATOR_NUMBERS)]
SWING_AMPLITUDE = [0, 0, 0, 0, 0.025, 0.025, 0.025, 0.025, 0.35/2, 0.35/2, 0.35/2, 0.35/2, 0.262, 0.262, 0.262, 0.262] 
STANCE_AMPLITUDE = [0, 0, 0, 0, 0, 0, 0, 0, 0.35/2, 0.35/2, 0.35/2, 0.35/2, 0, 0, 0, 0] 
# 4. offset
...
pace_parameters = cpg_config("pace", OSCILLATOR_NUMBERS, CONSTANT_AR, CONSTANT_AX, TIME_STEP, 
                             COUPLING_WEIGHTS, PACE_VECTOR, SPEED_STANCE, SPEED_SWING, 
...
if __name__ == '__main__':
    ...
    test_cpg = tqbotCpg(pace_parameters)
